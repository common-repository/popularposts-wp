<?php
/*
Plugin Name: PopularPosts WP
Plugin URI: http://plugins.extendedproduct.com/popularposts-wp-plugin
Description: Allows you to show your most popular posts as a widget on your blog.
Version: 1.0.0
Author: ExtendedProduct.com
Author URI: http://www.extendedproduct.com
*/

/*  Copyright 2010 ExtendedProduct.com - support@extendedproduct.com
...
add_action('admin_menu', 'popularposts_wp_add_pages');
register_activation_hook(__FILE__,'PopularPosts_install');

// action function for above hook
function popularposts_wp_add_pages() {
    add_options_page('PopularPosts WP', 'PopularPosts WP', 'administrator', 'popularposts_wp', 'popularposts_wp_options_page');
}
...
// popularposts_wp_options_page() displays the page content for the Test Options submenu
function popularposts_wp_options_page() {
...
<?php
    ...
    echo "<h2>" . __( 'PopularPosts WP Plugin Options', 'mt_trans_domain' ) . "</h2>";
...
register_sidebar_widget('PopularPosts WP', 'show_PopularPostss');
}
...
echo '<p style="font-size:x-small">PopularPosts Plugin made by <a href="http://www.xeromi.net">Web Hosting</a></p>';
}
